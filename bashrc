...
if [ "$color_prompt" = yes ]; then
	PS1='$?:${debian_chroot:+($debian_chroot)}'$bold_red'$(__reboot_icon__)'$bold_white'$(__updates_icon__)'$bold_magenta'[$TMUX_PANE/$TOPLVL/$SHLVL]'$bold_green'\u@\h'$reset':'$bold_blue'\w'$bold_cyan'$(__git_prompt__)'$reset'\n'$COLOR_DEFAULT'\$ '
else
